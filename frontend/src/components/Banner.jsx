...
const Banner = () => {
  return (
    <section
      ...
      className="relative overflow-hidden bg-gradient-to-r from-indigo-600 to-indigo-300 text-white"
    >
      {/* Background images (large and small) */}
      <img
        src={assets.main_banner_bg}
        alt="Fresh produce and grocery banner background"
        className="hidden md:block w-full h-[420px] object-cover opacity-80"
        aria-hidden="true"
      />
      <img
        ...
        <div className="container mx-auto px-6 md:px-12 lg:px-20 py-12 md:py-0 flex w-full">
          <div className="max-w-2xl bg-transparent md:bg-transparent backdrop-blur-sm/0">
            ...
            <p className="mt-4 text-sm md:text-base text-white max-w-prose">
              Handpicked items delivered fast — discover seasonal deals and
            ...
            <div className="mt-6 flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-4">
              ...
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 px-5 py-3 rounded-full bg-indigo-300 text-white border border-white/20 font-medium hover:bg-indigo-500/90 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-300 transition"
              >
                Explore Deals
                <svg
